...
boolean analyze_input_line(char*, HashMapPtr macro_map, int* line_index);
void fix_symbol_addresses();
boolean first_pass_exec(FILE * file_handle, HashMapPtr macro_map, int* line_index);
boolean label_actions(char*, HashMapPtr macro_map, int* line_index);
...
boolean operation(char*, int* line_index);
